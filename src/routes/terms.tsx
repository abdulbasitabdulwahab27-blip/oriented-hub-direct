  ...
  component: () => (
    <article className="container-page py-12 md:py-16 max-w-3xl">
      ...
      <div className="mt-8 space-y-5 text-foreground/90 leading-relaxed">
        ...
        <p>We offer nationwide delivery across Nigeria and worldwide shipping on request. Delivery timelines and fees depend on location, item availability and logistics conditions.</p>
