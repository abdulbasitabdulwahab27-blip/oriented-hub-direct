...
export const Route = createFileRoute("/sitemap.xml")({
  server: {
    handlers: {
      GET: async () => {
        const staticPaths = ["/", "/shop", "/order", "/track", "/procurement", "/about", "/contact", "/faq", "/privacy", "/terms", "/sales-rep", "/books", "/medical-equipment", "/laboratory-equipment", "/hospital-consumables", "/educational-materials", "/business-solutions", "/osogbo", "/delivery-information", "/blog", "/reviews", "/medical-equipment-supplier", "/laboratory-equipment-supplier", "/hospital-consumables-and-stationeries", "/medical-textbooks-supplier", "/nuc-accreditation-textbooks-supplier", "/international-book-seller"];
