...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nigeria's premium procurement platform for books, medical equipment, laboratory instruments, hospital consumables and educational materials." },
      { name: "author", content: "Oriented Hub" },
      { property: "og:title", content: "Oriented Hub — Quality Products. Better Care. Total Solutions." },
      { property: "og:description", content: "Nigeria's premium procurement platform for books, medical equipment, laboratory instruments, hospital consumables and educational materials." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Oriented Hub — Quality Products. Better Care. Total Solutions." },
      { name: "twitter:description", content: "Nigeria's premium procurement platform for books, medical equipment, laboratory instruments, hospital consumables and educational materials." },
