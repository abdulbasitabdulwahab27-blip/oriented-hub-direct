...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Oriented Hub — Procurement Platform" },
      { property: "og:description", content: "Books, medical equipment, lab instruments and hospital consumables — nationwide delivery in Nigeria." },
