...
export const products: Product[] = [
  ...
  { id: "p143", slug: 'ld3-electronic-centrifuge', name: 'LD-3 Electronic Laboratory Centrifuge', category: 'laboratory', image: p143img.url, description: 'Sourced from verified suppliers. Bulk and institutional pricing available on request.', features: ['Up to 4000 rpm', 'Adjustable timer & speed', 'Benchtop design'], bestSeller: true },
  ...
  { id: "p145a", slug: 'primary-health-care-banerjee', name: 'Primary Health Care: Concept and Implementation', category: 'books', image: p145img.url, description: 'Authentic copy supplied by Oriented Hub. Bulk and institutional pricing available on request.', features: ['Bratati Banerjee', 'AITBS Publishers, India'] },
  { id: "p145b", slug: 'community-medicine-pgmee-shaikh', name: 'A Complete Review of Community Medicine for PGMEE', category: 'books', image: p145img.url, description: 'Authentic copy supplied by Oriented Hub. Bulk and institutional pricing available on request.', features: ['Dr. Zakirhusain Shaikh', '1000+ MCQs from AIIMS, AIPGME, UPSC', 'With explanatory answers'] },
  { id: "p145c", slug: 'basic-clinical-epidemiology-dhikav', name: 'Basic and Clinical Epidemiology (2nd Edition)', category: 'books', image: p145img.url, description: 'Authentic copy supplied by Oriented Hub. Bulk and institutional pricing available on request.', features: ['Vikas Dhikav', 'AITBS Publishers, India'] },
  { id: "p146a", slug: 'safety-occupational-health-construction-sharma', name: 'Safety, Occupational Health and Environmental Management in Construction', category: 'books', image: p146img.url, description: 'Authentic copy supplied by Oriented Hub. Bulk and institutional pricing available on request.', features: ['S. C. Sharma & Vineet Kumar', 'Khanna Publishers'] },
  { id: "p146b", slug: 'who-drinking-water-quality-guidelines', name: 'WHO Guidelines for Drinking-water Quality (3rd Ed, Vol. 1)', category: 'books', image: p146img.url, description: 'Authentic copy supplied by Oriented Hub. Bulk and institutional pricing available on request.', features: ['World Health Organization', 'Authorised reprint', 'Recommendations'] },
  { id: "p146c", slug: 'public-health-management-sunder-lal', name: 'Public Health Management: Principles and Practice (2nd Edition)', category: 'books', image: p146img.url, description: 'Authentic copy supplied by Oriented Hub. Bulk and institutional pricing available on request.', features: ['Sunder Lal & Vikas', 'CBS Publishers'] },
